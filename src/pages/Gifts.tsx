...
const WalletStyles = `
  .wallet { position:relative; width:280px; height:230px; cursor:pointer; perspective:1000px; display:flex; justify-content:center; align-items:flex-end; transition:transform 0.4s ease; }
  .wallet:hover { transform:translateY(-5px); }
  .wallet-back { position:absolute; bottom:0; width:280px; height:200px; background:#1e341e; border-radius:22px 22px 60px 60px; z-index:5; box-shadow:inset 0 25px 35px rgba(0,0,0,0.4),inset 0 5px 15px rgba(0,0,0,0.5); }
  @keyframes slideIntoPocket { 0%{transform:translateY(-100px);opacity:0;} 100%{transform:translateY(0);opacity:1;} }
  .card { position:absolute; width:260px; height:140px; left:10px; border-radius:16px; padding:18px; color:white; box-shadow:inset 0 1px 1px rgba(255,255,255,0.3),0 -4px 15px rgba(0,0,0,0.1); transition:transform 0.6s cubic-bezier(0.34,1.56,0.64,1); animation:slideIntoPocket 0.8s cubic-bezier(0.2,0.8,0.2,1) backwards; }
  .card-inner-w { display:flex; flex-direction:column; justify-content:space-between; height:100%; }
  ...
  .pocket { position:absolute; bottom:0; width:280px; height:160px; z-index:40; filter:drop-shadow(0 15px 25px rgba(20,40,20,0.4)); }
  .pocket-content { position:absolute; top:110px; width:100%; text-align:center; z-index:50; display:flex; flex-direction:column; align-items:center; gap:6px; }
  ...
  .wallet::after { content:"Hover para ver las tarjetas"; position:absolute; bottom:-28px; font-style:italic; color:rgba(245,197,24,0.6); font-size:12px; font-weight:500; white-space:nowrap; }
`;
  ...
  <div className="wallet">
    ...
    <div className="card card-1">
      <div className="card-inner-w">
        <div className="card-top"><span>Roblox</span><div className="chip" /></div>
        <div className="card-bottom"><div><span className="label">Gift Card</span><span className="value">🎮 Roblox</span></div></div>
      </div>
    </div>
    <div className="card card-2">
      <div className="card-inner-w">
        <div className="card-top"><span>Google / Target</span><div className="chip" /></div>
        <div className="card-bottom"><div><span className="label">Gift Card</span><span className="value">🔍 Google · 🎯 Target</span></div></div>
      </div>
    </div>
    <div className="card card-3">
      <div className="card-inner-w">
        <div className="card-top"><span>In-N-Out · Visa</span><div className="chip" /></div>
        <div className="card-bottom"><div><span className="label">Gift Card</span><span className="value">🍔 In-N-Out · 💳 Visa</span></div></div>
      </div>
    </div>
          ...
          section.link ? (
            <Link to={section.link} key={section.title} style={{ textDecoration: "none" }}>
              <motion.div
                ...
                style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)", backdropFilter: "blur(12px)", cursor: "pointer" }}
                variants={fadeUp}
                custom={i + 2}
                whileHover={{ scale: 1.02, background: "rgba(255,255,255,0.08)" } as any}
              >
